...
resource "kubernetes_deployment" "carts-deployment" {
  metadata {
    name      = "carts"
...
resource "kubernetes_service" "carts-service" {
  metadata {
    name      = "carts"
    namespace = kubernetes_namespace.kube-namespace.id
...
resource "kubernetes_deployment" "cartsdb-deployment" {
  metadata {
    name      = "carts-db"
    namespace = kubernetes_namespace.kube-namespace.id
    labels = {
...
resource "kubernetes_service" "cartsdb-service" {
  metadata {
    name      = "cartsdb"
    namespace = kubernetes_namespace.kube-namespace.id
    labels = {
...
resource "kubernetes_deployment" "catalogue-deployment" {
  metadata {
    name      = "catalogue"
    namespace = kubernetes_namespace.kube-namespace.id
    labels = {
...
resource "kubernetes_service" "catalogue-service" {
  metadata {
    name      = "catalogue"
    namespace = kubernetes_namespace.kube-namespace.id
...
resource "kubernetes_deployment" "catalogue-db-deployment" {
  metadata {
    name      = "catalogue-db"
    namespace = kubernetes_namespace.kube-namespace.id
    labels = {
...
resource "kubernetes_service" "catalogue-db-service" {
  metadata {
    name      = "catalogue-db"
    namespace = kubernetes_namespace.kube-namespace.id
    labels = {
